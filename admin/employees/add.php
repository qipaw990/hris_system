...
<div class="row">
    <div class="col-12">
        <form action="/hrm/admin/employees/process_add.php" method="POST" enctype="multipart/form-data" id="addEmployeeForm">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="employee_code" name="employee_code" 
                                   value="<?php echo htmlspecialchars($employeeCode); ?>" readonly>
                        </div>
                        <div class="col-md-4 mb-3">
